...
for f in 1 8; do
    ...
    for i in 1; do
	python jellyfish.py -t jf -r ksp -dir tp_results_jf_ksp_$i -nse 12 -nsw 15 -np 4 -e t -f $f
	python jellyfish.py -t jf -r ecmp -dir tp_results_jf_ecmp_$i -nse 12 -nsw 15 -np 4 -e t -f $f
